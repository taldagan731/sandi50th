...
requireText("components/RevealSoundtrackV2.tsx", "const [duckRatio, setDuckRatio] = useState(DEFAULT_DUCK_RATIO)", "the adjustable owner rehearsal music bed during spoken messages");
requireText("components/RevealSoundtrackV2.tsx", "const activeDuckRatio = mediaFocusActive ? .05 : duckRatio", "music ducking that preserves a soft bed");
requireText("components/RevealSoundtrackV2.tsx", "masterMuted || externalAudioActive || speakingRef.current || !chorusEnabled ? 0 : .13", "full name-chorus silence during spoken messages");
